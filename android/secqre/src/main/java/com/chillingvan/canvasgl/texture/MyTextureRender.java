...
public class MyTextureRender implements GLViewRenderer, GLSurfaceView.Renderer {
    int mHeight = 0;
...
//    private com.rrioo.smartlife.module.camera.MyRender.RenderListener listener;
    private boolean isTakePicture = false;

    public MyTextureRender() {
...
//    }
//
//    public void setListener(com.rrioo.smartlife.module.camera.MyRender.RenderListener listener) {
//        this.listener = listener;
//    }

    public MyTextureRender(GLSurfaceView paramGLSurfaceView) {
        this();
