...
public class DeviceSDK
{
	 ...
	 * @return
	 */
	public static int startRecordVideo2(long userID, String fileName, int height,int width, int framerate)
	{
		return NativeCaller.StartRecord(userID, fileName, height, width, framerate);
	}
	/**
	 * 结束录像
	 * @return
	 */
	public static int stopRecordVideo2(long userID)
	{
	...
	{
		return NativeCaller.SearchRecordFile(userid, bYear, bMon, bDay, 0, 0, 0, eYear, eMon, eDay, 23, 59, 59,0,0);
	}
